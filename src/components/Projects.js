...
const styles = {
    ...
    closeButton: { position: 'absolute', top: '15px', right: '15px', width: '36px', height: '36px', borderRadius: '50%', backgroundColor: 'rgba(220,38,38,0.1)', border: 'none', fontSize: '16px', color: '#DC2626', cursor: 'pointer', fontWeight: 'bold', zIndex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
    modalHeader: { display: 'flex', alignItems: 'center', gap: '20px', marginBottom: '30px', paddingBottom: '25px', paddingRight: '45px', borderBottom: '2px solid rgba(220,38,38,0.1)', flexWrap: 'wrap' },
    ...
    modalTitle: { fontSize: 'clamp(18px, 4vw, 26px)', color: '#1F1F1F', fontWeight: '700', margin: 0, lineHeight: '1.2', flex: 1, minWidth: 0, wordBreak: 'break-word' },
