            ...
            <div style={styles.content}>
                ...
                <div style={styles.ctaBox}>
                    ...
                    <form ref={formRef} onSubmit={handleSubmit} style={styles.form}>
                        ...
                        {status === 'success' && (
                            <div style={styles.successMsg}>✅ ส่งข้อความสำเร็จ! จะติดต่อกลับโดยเร็ว</div>
                        )}
                        {status === 'error' && (
                            <div style={styles.errorMsg}>❌ เกิดข้อผิดพลาด กรุณาลองใหม่อีกครั้ง</div>
                        )}
